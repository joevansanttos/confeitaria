# Generated by Django 3.2.21 on 2023-09-28 18:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incalculable_expenses', models.FloatField(db_column='incalculable_expenses', verbose_name='Custos Incalculáveis (R$):')),
                ('marketplace_tax', models.FloatField(db_column='marketplace_tax', verbose_name='Taxa de Comissão em Marketplace (R$):')),
                ...
                ('percent_ingredients', models.ManyToManyField(to='myapp.PercentIngredient')),
                ('percent_materials', models.ManyToManyField(to='myapp.PercentMaterial')),
                ('user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['name'],

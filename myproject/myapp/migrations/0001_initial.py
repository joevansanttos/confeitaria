# Generated by Django 3.2.21 on 2023-10-03 11:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_column='name', max_length=100, verbose_name='Nome do Custo:')),
                ('price', models.FloatField(db_column='price', verbose_name='Preço (R$):')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_column='name', max_length=100)),
                ('another_expenses', models.FloatField(db_column='another_expenses', verbose_name='Outros Custos (R$):')),
                ('incalculable_expenses', models.FloatField(blank=True, db_column='incalculable_expenses', verbose_name='Custos Incalculáveis (R$):')),
                ('marketplace_tax', models.FloatField(db_column='marketplace_tax', verbose_name='Taxa de Comissão em Marketplace %:')),
                ('taxes', models.FloatField(db_column='taxes', verbose_name='Impostos:')),
                ('quantity', models.IntegerField(db_column='quantity', verbose_name='Quantidade Desejada:')),
                ('profit', models.FloatField(db_column='profit', verbose_name='Lucro Desejado (R$):')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hours', models.FloatField(db_column='hours', verbose_name='Horas de Consumo:')),
                ('time', models.CharField(choices=[('Hora', 'Hora'), ('Minutos', 'Minutos'), ('Segundos', 'Segundos'), ('Dias', 'Dias')], max_length=15, verbose_name='Tempo de Medida:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours', models.FloatField(db_column='hours', verbose_name='Horas de Consumo:')),
                ('time', models.CharField(choices=[('Hora', 'Hora'), ('Minutos', 'Minutos'), ('Segundos', 'Segundos'), ('Dias', 'Dias')], max_length=15, verbose_name='Tempo de Medida:')),
                ('cost', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.cost')),
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.product')),
            ],
            options={
                'ordering': ['cost'],
